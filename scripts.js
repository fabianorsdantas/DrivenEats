function selecionarPrato(prato) {
  ...
  function confirmaPedido() {
    document
      .querySelector(".janela-confirmacao")
  ...
  function enviaPedido() {
    ...
    const linkWhatsApp = `https://wa.me/5584999501021?text=${encodeURIComponent(
      mensagemDoPedido
    )}`;
  ...
  function cancelaPedido() {
    ...
    finalizarPedido.firstElementChild.classList.remove("oculto");
    finalizarPedido.lastElementChild.classList.add("oculto");
